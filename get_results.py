...
def batch_means(parameter_dict, time, todelete_t0, k, malfunction_flag= False, alpha= 0.05):
    
    d= base.run_simulation(simulation_time= time, parameter_dict= parameter_dict, malfunction_flag= malfunction_flag, seed= 10)
